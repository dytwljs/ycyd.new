...
module.exports = class extends Base {
  ...
  async detailAction() {
    ...
    const attribute = await this.model('goods_attribute').field('yc_goods_attribute.value, yc_attribute.name').join('yc_attribute ON yc_goods_attribute.attribute_id=yc_attribute.id').order({'yc_goods_attribute.id': 'asc'}).where({'yc_goods_attribute.goods_id': goodsId}).select();
