	...
	<div class="content-page">
		<div class="content-nav">
			<el-breadcrumb class="breadcrumb" separator="/">
				...
				<el-breadcrumb-item>销售商预登记</el-breadcrumb-item>
			</el-breadcrumb>
		...
		<div class="content-main">
          ...
          <el-table-column prop="authorize" label="审核状态">
            <template scope="scope">
              ...
              <div v-if="scope.row.authorize==1" class="bg-left">已审核</div>
            </template>
          </el-table-column>
    ...
    methods: {
      ...
      handleRowDelete(index, row) {
        ...
        this.$confirm('确定要删除?', '提示', {
          ...
          this.axios.post('sale/destoryReg', { mobile: row.mobile }).then((response) => {
